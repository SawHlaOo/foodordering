      ...
      <section>
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 via-brand-600 to-sage-600 px-5 py-7 text-white shadow-soft sm:px-8 sm:py-9">
          <div className="max-w-2xl">
            <p className="mb-2 text-xs font-bold uppercase tracking-[0.22em] text-sage-100">FlavorFlow special</p>
            ...
            <Link to="/menu" className="mt-6 inline-flex rounded-full bg-white px-5 py-3 text-sm font-bold text-brand-700 shadow-sm transition hover:bg-brand-50">
